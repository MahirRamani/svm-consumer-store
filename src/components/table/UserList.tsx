...
// // const DEFAULT_ROLE_CONFIG = ROLE_CONFIG;
...
//                           <div className="flex flex-wrap gap-1">
//                             {user.allowedTabs.map((tabId) => (
//                               <Badge key={tabId} variant="secondary" className="text-xs capitalize font-normal">
//                                 {TABS_REGISTRY[tabId as keyof typeof TABS_REGISTRY]?.label ?? tabId}
//                               </Badge>
//                             ))}
//                           </div>
...
// // } from "@/components/ui/table";
// // import { Skeleton } from "@/components/ui/skeleton";
// // import { Edit, Trash2, Users, ShieldCheck, User as UserIcon, Calculator, Tag, Crown } from "lucide-react";
// // import EditUserModal from "@/components/modals/edit-user-modal";
// // import ConfirmDialog from "@/components/dialogs/ConfirmDialog";
// // import { useMutation, useQueryClient } from "@tanstack/react-query";
// // import { ApiResponse } from "@/lib/api/base-handler";

// // // ✅ No more onUserDeleted / onUserEdited callbacks needed
// // interface UserListProps {
// //   users: User[];
// //   isLoading?: boolean;
// // }

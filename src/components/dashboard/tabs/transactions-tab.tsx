...
// } from "lucide-react";
// import { toast } from "sonner";
// import RevertTransactionModal from "@/components/modals/revert-transaction-modal";
...
//   const handleRevertClick = useCallback((transaction: any) => {
//     // Parse items if they're in string format
//     const items = Array.isArray(transaction.items)
//       ? transaction.items
//       : parseTransactionItems(
...
//   const canRevert = useCallback((transaction: any): boolean => {
//     return (
//       transaction.status === "Completed" &&
//       transaction.transactionType !== "Reverted" &&
//       transaction.transactionType !== "Partial Revert"
//     );
//   }, []);

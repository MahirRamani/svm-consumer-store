...
// Export Routes
// =============================================
export const GET = withErrorHandler(withRole(['SUPERUSER', 'ACCOUNTANT', 'ADMIN'])(getStudentsHandler));
export const POST = withErrorHandler(withRole(['SUPERUSER', 'ACCOUNTANT', 'ADMIN'])(createStudentHandler));
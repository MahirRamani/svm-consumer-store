...
export const PATCH = withErrorHandler(withRole(['SUPERUSER', 'ADMIN', 'ACCOUNTANT'])(updateStudentHandler));
export const DELETE = withErrorHandler(withRole(['SUPERUSER', 'ADMIN'])(deleteStudentHandler));
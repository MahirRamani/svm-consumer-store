...
async function deductStockByTransactionId(
  ...
  if (stockTransaction.transactionType !== 'Buy') {
...
//   // Determine transaction type
//   if (body.transactionType === 'Purchase' || body.items) {
//     const data = await validateBody(req, createPurchaseTransactionSchema);
//     return createPurchaseHandler(data as CreatePurchaseDto);
//   } else if (body.transactionType === 'Topup') {
//     const data = await validateBody(req, createTopupTransactionSchema);
//     return createTopupHandler(data as CreateTopupDto);
//   } else if (body.transactionType === 'Deduction') {
//     const data = await validateBody(req, createDeductionTransactionSchema);
//     return createDeductionHandler(data as CreateDeductionDto);
//   }
...
//     // Build filter query
//     const filter: any = {
//       transactionType: "Purchase" // Based on your UI, we're showing purchase transactions
//     }

//     // Status filter
//     if (status !== "all") {
//       // TODO - Remove "any"
//       // Map UI status to your schema status
//       const statusMap: any = {
//         completed: "Completed",
//         failed: "Cancelled",
//         refunded: "Cancelled", // You might want to add a refunded status to your schema
//       }
...
//     let searchFilter = {}
//     if (search) {
//       // First, try to find students matching the search term
...
//       // Build search filter for transaction ID or student match
//       searchFilter = {
//         $or: [
//           { _id: { $regex: search, $options: "i" } }, // Transaction ID search
//           { studentId: { $in: studentIds } } // Student search
//         ]
//       }
//     }
...
//     const transactionsWithItemDetails = await Promise.all(
...
//           },
//           items: JSON.stringify(itemsWithNames), // UI expects JSON string
